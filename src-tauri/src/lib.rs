...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::library::get_tags_with_meta_for_tracks,
            commands::library::get_all_track_tags,
            commands::library::get_all_tags,
            commands::library::add_user_tag,
            commands::library::remove_user_tag,
            commands::library::suppress_tag,
            commands::library::unsuppress_tag,
            ...
            commands::analysis::set_analysis_manually_paused,
            commands::analysis::set_analysis_auto_paused,
            commands::analysis::get_analysis_paused_status,
